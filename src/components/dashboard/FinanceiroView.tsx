...
export function FinanceiroView({
  ...
  const getCardValue = (val: number) =>
    val >= 10000 ? formatNoCents(val) : formatFull(val);
      ...
      <div className="flex justify-between items-center px-2">
        ...
        <div className="flex bg-white rounded-lg border border-slate-200 p-0.5">
          <button
            ...
            className={`px-3 py-1.5 text-xs font-bold rounded-md transition-colors ${filterPeriod === "DIA" ? "bg-indigo-100 text-indigo-700" : "text-slate-400 hover:text-slate-600"}`}
          >
            Hoje
          </button>
          <button
            onClick={() => setFilterPeriod("MES")}
            className={`px-3 py-1.5 text-xs font-bold rounded-md transition-colors ${filterPeriod === "MES" ? "bg-indigo-100 text-indigo-700" : "text-slate-400 hover:text-slate-600"}`}
          >
            Mês
          </button>
          <button
            onClick={() => setFilterPeriod("TODOS")}
            className={`px-3 py-1.5 text-xs font-bold rounded-md transition-colors ${filterPeriod === "TODOS" ? "bg-indigo-100 text-indigo-700" : "text-slate-400 hover:text-slate-600"}`}
          >
            Tudo
          </button>
        </div>
