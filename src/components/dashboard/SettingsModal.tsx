...
export function SettingsModal({
  ...
  const getBusinessLabel = () => {
    ...
    return (
      BUSINESS_SIZES[formData.businessSize as keyof typeof BUSINESS_SIZES]
        ?.label || "Selecione..."
    );
  };
              ...
              {user.type === "PJ" && (
                <div className="relative" ref={businessSizeRef}>
                  ...
                  >
                    ...
                    <ChevronDown
                      size={16}
                      className={`text-slate-400 transition-transform ${isBusinessSizeOpen ? "rotate-180" : ""}`}
                    />
                  </button>
                  ...
                  <p className="text-[10px] text-slate-400 mt-1 ml-1">
                    Isso ajusta o seu limite de alerta fiscal no painel.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                    ...
                    <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-1 animate-in fade-in">
                      {passwordRequirements.map((req, idx) => {
                        ...
                        return (
                          <div
                            key={idx}
                            className={`flex items-center gap-1.5 text-[10px] font-bold ${met ? "text-emerald-600" : "text-slate-400"}`}
                          >
                            {met ? (
              ...
              <div className="pt-6 border-t border-slate-100">
                ...
                <p className="text-xs text-slate-500 mb-4">
                  Ao excluir sua conta, todas as transações, clientes e dados
                  serão apagados permanentemente. Esta ação não pode ser
                  desfeita.
                </p>
                <button
                  type="button"
