...
export default function Dashboard() {
  ...
  const [currentTab, setCurrentTab] = useState<"HOME" | "FLOW" | "REPORTS">("HOME");
    ...
    <div className="min-h-screen bg-slate-50 pb-28">
      ...
      <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-30 flex items-center gap-3 w-full justify-center pointer-events-none">
        <div className="pointer-events-auto flex items-center gap-3">
          ...
          {!isInputMode && (
            <button onClick={handleOpenModalManual} className="bg-indigo-600 text-white px-6 py-3 rounded-full shadow-xl shadow-indigo-300 flex items-center gap-2 font-bold hover:bg-indigo-700 active:scale-95 transition-all transform hover:-translate-y-1 h-[56px] animate-in fade-in zoom-in"><Plus size={20} /> Registrar</button>
          )}
        </div>
      </div>
