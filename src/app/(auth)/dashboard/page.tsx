...
const DEFAULT_COLORS = ["#6366f1", "#10b981", "#f59e0b", "#f43f5e", "#8b5cf6", "#ec4899", "#06b6d4"];

// Interface para satisfazer o TypeScript no Label do Gráfico
...
export default function Dashboard() {
  ...
  const getDisplayTitle = (t: Transaction) => {
    ...
    const suf =
      t.totalInstallments != null && t.installment != null && t.totalInstallments > 1
                ...
                <div key={t._id} className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex justify-between items-center animate-in slide-in-from-bottom-2">
                  <div className="flex items-center gap-3 overflow-hidden">
                    ...
                    <div className="min-w-0">
                      <p className="font-bold text-slate-700 text-sm truncate max-w-[150px]">{getDisplayTitle(t)}</p>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                            <Pie
                                ...
                                stroke="#ffffff" 
                                strokeWidth={2}
                                label={isMobile ? false : ({ name, percent, value }: CustomPieLabelProps) => {
                                    const p = percent || 0;
                ...
                {futureTransactions.slice(0, 5).map(t => (
                  <div key={t._id} className="flex justify-between items-center text-sm border-b border-slate-50 last:border-0 pb-2 last:pb-0">
                    <div className="flex flex-col">
                      <span className="font-bold text-slate-700 truncate max-w-[150px]">{getDisplayTitle(t)}</span>
